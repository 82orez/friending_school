...
// ── 수강신청 접수 시간창 ────────────────────────────────────────────────
// KST 10:00~19:00에만 신청을 받는다(19:00부터 익일 10:00까지 마감).
...
//    개시 시각 이력: 08:00(20260826220248) → 07:00(20260827210254) → **10:00(20260906211254)**.
export const PREP_APPLY_OPEN_MIN = 10 * 60;
export const PREP_APPLY_CLOSE_MIN = 19 * 60;

// 배너 안내와 서버 액션 에러 문구가 어긋나지 않도록 문장도 여기 한 곳에 둔다.
export const PREP_APPLY_WINDOW_LABEL = "오전 10시~오후 7시";
export const PREP_APPLY_CLOSED_MSG = `수강신청은 매일 ${PREP_APPLY_WINDOW_LABEL}에만 가능합니다.`;

// ── 입금 기한 ───────────────────────────────────────────────────────────
// 신청 당일 KST 21:00. 접수 시간창이 10:00~19:00이라 기한은 항상 신청 시점보다 뒤다(경계 예외 없음).
