...
- `docs/admin.md` — admin 대시보드 14탭(수강신청·화상수업·회원·강사/프렌더 승인·**연습방 모니터링/강제 삭제**·**프렙 강좌 심사**·센터·매출·매출이익·시뮬레이션·정산·유튜브·공지)
